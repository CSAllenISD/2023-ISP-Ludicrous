...
function BasicShotgun.new(owner: Player, ignore: {Instance})
	...
	newBasicShotgun.Ammo = 1
	newBasicShotgun.MagSize = 1
	newBasicShotgun.ShotCount = 32
	newBasicShotgun.Reserve = math.huge

	newBasicShotgun.ReloadTime = 1

	newBasicShotgun.VerticalSpread = Vector2.new(-5.5,5.5)
	newBasicShotgun.HorizontalSpread = Vector2.new(-5.5,5.5)
	
	newBasicShotgun.VerticalRecoil = Vector2.new(300,350)
