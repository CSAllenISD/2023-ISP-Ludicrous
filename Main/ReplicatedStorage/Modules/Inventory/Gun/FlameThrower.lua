...
function FlameThrower.new(owner: Player, ignore: {Instance})
	...
	newFlameThrower.Firerate = 900
	newFlameThrower.Firemode = "Auto" -- "Semi", "Auto"

	newFlameThrower.Ammo = 100
	newFlameThrower.MagSize = 100
	...
	newFlameThrower.Projectile = RepStor.Modules.ProjectileModules.Projectiles.Flame
