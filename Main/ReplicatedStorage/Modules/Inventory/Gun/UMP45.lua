...
local AnimationRepo = RepStor.Assets.Animations.Tools.AK47
...
function AK47.new(owner: Player, ignore: {Instance})
	...
	newAK47.OnShot.Event:Connect(function()
		...
		newAK47.ViewModel:PlayAnimation(AnimationRepo.AK47_Shoot, nil, nil, 5)
